...
class Fragment1 : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.pv.setOnPhotoTapListener { view, x, y ->
            ...
            var x1= (clickCoordinate.x*10000)
            var y1= (clickCoordinate.y*10000)

            var xx= String.format("%.4f", x1)
            var yy= String.format("%.4f", y1)
            ...
            stationcoordinate.forEach { list ->
                list.forEach {
                    ...
                    var x2= (it.value.x*10000)
                    var y2= (it.value.y*10000)

//                    var xcoord= xx - it.value.x
//                    var ycoord= yy - it.value.y
